...
export function envConfig(state = null, action) {
    switch (action.type) {
        case RECEIVE_ENV_CONFIG:
            ...
            // The authentication and matlab pieces of redux state are updated accordingly for the RECEIVE_ENV_CONFIG action type. Hence, storing the rest of the envConfig without authentication and matlab info. 
